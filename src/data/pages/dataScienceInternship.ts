  ...
  content: Page(
    ...
    Body(
      ...
      Paragraph(
        ...
        ' starting on February 25th, 2019 and ending March 22nd, 2019.'
      ),
      ...
      Paragraph(
        `The training will be delivered by Dimitri who is our inter-disciplinary engineer who leads teleportHQ's R&D for automatic design generation. The training will be organised around 3 core activities:`
      ),
      Paragraph(
        UnorderedList(
